...
<template>
  <RoleLayout role="trainer" sidebar-title="Trainer" title="Notifications" subtitle="Read schedule updates and system messages." :sidebar-items="trainerSidebarItems">
