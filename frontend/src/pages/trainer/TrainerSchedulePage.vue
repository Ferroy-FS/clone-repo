...
<template>
  <RoleLayout role="trainer" sidebar-title="Trainer" title="Schedule" subtitle="Manage upcoming classes and personal training sessions." :sidebar-items="trainerSidebarItems">
    <div class="grid gap-4 md:grid-cols-3">
      <StatCard label="Today Sessions" value="4" hint="Placeholder" />
      <StatCard label="Assigned Members" value="18" hint="Placeholder" />
      <StatCard label="Class Rating" value="4.8" hint="Placeholder" />
    </div>

    <FitnezCard class="mt-5">
      <h2 class="text-2xl font-black">Schedule Module</h2>
