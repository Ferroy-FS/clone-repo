...
<template>
  <RoleLayout role="admin" sidebar-title="Admin" title="Settings" subtitle="Configure branding, payment instruction, and access rules." :sidebar-items="adminSidebarItems">
    <div class="grid gap-4 md:grid-cols-3">
      ...
      <StatCard label="Access" value="Admin" hint="Protected route" />
    </div>

    <FitnezCard class="mt-5">
      <h2 class="text-2xl font-black">Settings Module</h2>
