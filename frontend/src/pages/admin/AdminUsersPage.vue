...
<template>
  <RoleLayout role="admin" sidebar-title="Admin" title="Users" subtitle="Manage admin, trainer, and member accounts." :sidebar-items="adminSidebarItems">
    ...
    <FitnezCard class="mt-5">
      <h2 class="text-2xl font-black">Users Module</h2>
